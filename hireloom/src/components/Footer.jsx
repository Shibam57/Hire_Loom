      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <motion.div variants={itemVariants}>
              <div className="mb-6">
                <div className="flex items-center">
                  ...
                  <h3 className="text-2xl font-bold text-white">Hireloom</h3>
                </div>
        ...
        >
          <div className="flex items-center mb-4 md:mb-0">
            ...
            <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent font-bold text-xl">Hireloom</span>
          </div>
